...
public:	
 ...
 unsigned long buildGetWaterPressureRequest();
 unsigned long buildGetBoilerflowTempRequest();
 unsigned long buildGetModulationLevelRequest();
 unsigned long buildGetExhaustTempRequest();
 unsigned long buildGetAppFaultRequest();
 ...
 float getCHwaterpressure();
 float getBoilerflowTemp();
 float getModulationLevel();
 float getExhaustTemp();
 float getAppFault();
};
